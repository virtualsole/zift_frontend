...
The Big Release!</h2>
   <span className="mt-lg-1 mb-lg-3 text-light releas-sd">We deliver up-to-date, breaking crypto news about the latest ZiftCoin.
...
<img src={Facbook} alt="" className="img-fluid mt-lg-4 releas-sd" />
